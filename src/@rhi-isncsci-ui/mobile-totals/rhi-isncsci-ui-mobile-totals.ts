...
export class RhiIsncsciUiMobileTotals extends HTMLElement {
    ...
    public _render(props): TemplateResult {
        return html`
            ...
            <div class="grid">
                ...
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-upper-motor']}</span></div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'right-upper-motor')}">${props['right-upper-motor']}</div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'left-upper-motor')}">${props['left-upper-motor']}</div>
                </div>
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-lower-motor']}</span></div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'right-lower-motor')}">${props['right-lower-motor']}</div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'left-lower-motor')}">${props['left-lower-motor']}</div>
                </div>
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-light-touch']}</span></div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'right-touch')}">${props['right-touch']}</div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'left-touch')}">${props['left-touch']}</div>
                </div>
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-pin-prick']}</span></div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'right-prick')}">${props['right-prick']}</div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'left-prick')}">${props['left-prick']}</div>
                </div>
            </div>
            <div class="grid">
                <div class="row">
            ...
            <div class="grid">
                ...
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-sensory-nl']}</span></div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'right-sensory-nl')}">${props['right-sensory-nl']}</div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'left-sensory-nl')}">${props['left-sensory-nl']}</div>
                </div>
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-motor-nl']}</span></div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'right-motor-nl')}">${props['right-motor-nl']}</div>
                    <div class="cell interactive" on-click="${(e) => this.handleCellClick(e, 'left-motor-nl')}">${props['left-motor-nl']}</div>
                </div>
            </div>
            <div class="grid">
                <div class="row">
                ...
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-complete-incomplete']}</span></div>
            ...
            <div class="grid">
                ...
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-sensory-nl-zpp']}</span></div>
                    <div class="cell">${props['right-sensory-nl-zpp']}</div>
                    <div class="cell">${props['left-sensory-nl-zpp']}</div>
                </div>
                <div class="row">
                    <div class="label"><span class="text-align-right secondary-text">${props['text-motor-nl-zpp']}</span></div>
    ...
    public static get observedAttributes(): string[] {
        ...
        for (let key in RhiIsncsciUiMobileTotals.properties) {
    ...
    public ready(): void {
        ...
        const vac: HTMLSelectElement = <HTMLSelectElement>this['shadowRoot'].getElementById('anal-contraction');
        vac.addEventListener('change', (e) => this.handleVacChange(e));

        // Wire up Deep Anal Pressure events
        const dap: HTMLSelectElement = <HTMLSelectElement>this['shadowRoot'].getElementById('anal-sensation');
