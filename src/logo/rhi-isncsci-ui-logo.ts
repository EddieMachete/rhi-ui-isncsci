...
export class RhiIsncsciUiLogo extends HTMLElement {
    ...
    public getTemplate(svgElement: string): string {
        return `
            <style>
                :host {
                    display: block;
    ...
    private requestRender(): void {
        ...
        template.innerHTML = this.getTemplate(this.svgElement);
